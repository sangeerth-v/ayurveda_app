...
@section('title', 'Edit Doctor | Hospital')
...
<div class="row justify-content-center">
    <div class="col-lg-10">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="mb-1">Edit Doctor</h2>
                <p class="text-muted mb-0">Update this doctor's account and practice information.</p>
            </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <form action="{{ route('hospital.doctors.update', $doctor->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg w-100 mt-4"><i class="fas fa-save me-2"></i> Update Doctor</button>
                </form>
            </div>
        </div>
    </div>
