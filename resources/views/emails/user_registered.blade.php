...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Welcome to Ayurveda, {{ $user->name }}!</h2>
            <p>We are absolutely thrilled to welcome you to our community. Ayurveda is designed to connect you with experienced Ayurvedic doctors and provide high-quality healthcare products right to your doorstep.</p>
            <p>Your registration is complete. You can now browse our catalog of natural products, find specialized doctors, and book appointments easily.</p>
            <center>
                <a href="{{ url('/') }}" class="btn">Explore Now</a>
            </center>
        </div>
        <div class="footer">
